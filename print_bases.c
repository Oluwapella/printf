 ...
 * @f: pointer t the struct flags that determines
 ...
 * in uppercase
 * @l: va_list arguments from_printf
 ...
 * @l: va_list arguments from _printf
 * @f: pointer to the struct that determines
 * if a flag is passef to _printf
 * Description: the function calls convert() which in turn convert
 * the input number into the correct base and returns it as a string
 * Return: the number of char printed
 */
